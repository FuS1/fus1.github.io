...
@section('content')  
  <div class="container tw-bg-white md:tw-text-2xl tw-max-w-[1180px] tw-h-full tw-shadow-md">
    ...
    <div class="droppable tw-min-h-5 tw-p-3 tw-border-2 tw-border-dashed tw-border-amber-900 tw-rounded tw-flex tw-my-2 md:tw-mx-10 md:tw-my-6 tw-bg-slate-100 tw-w-[90%] tw-mx-auto ui-droppable" data-is_stock_area="yes">
      ...
      </div><div class="" style="box-shadow: 11px 14px 1px 1px rgb(132 203 241);border-radius: 30px;padding: 22px; margin: 0 2.5rem;">
      <div class="tw-border-l-4 tw-border-orange-300 tw-pl-3 tw-py-1 md:tw-p-3 md:tw-mx-10 tw-my-2 md:tw-my-6 tw-leading-8 md:tw-leading-10">
        ...
        <div class="tw-flex">I know how to <div class="droppable question tw-mx-2 tw-border-b tw-border-amber-700 tw-w-28 tw-h-10 ui-droppable" data-answer="jump"></div> .</div>  
      </div>
      
      <div class="tw-border-l-4 tw-border-orange-300 tw-pl-3 tw-py-1 md:tw-p-3 md:tw-mx-10 tw-my-2 md:tw-my-6 tw-leading-8 md:tw-leading-10">
        <div>I am a cicada.</div>
        <div class="tw-flex">I know how to <div class="droppable question tw-mx-2 tw-border-b tw-border-amber-700 tw-w-28 tw-h-10 ui-droppable" data-answer="sing"></div> .</div>  
      </div>

      <div class="tw-border-l-4 tw-border-orange-300 tw-pl-3 tw-py-1 md:tw-p-3 md:tw-mx-10 tw-my-2 md:tw-my-6 tw-leading-8 md:tw-leading-10">
        <div>I am a male stag bettle.</div>
        <div class="tw-flex">I know how to <div class="droppable question tw-mx-2 tw-border-b tw-border-amber-700 tw-w-28 tw-h-10 ui-droppable" data-answer="fight"></div> .</div>  
      </div>

      <div class="tw-border-l-4 tw-border-orange-300 tw-pl-3 tw-py-1 md:tw-p-3 md:tw-mx-10 tw-my-2 md:tw-my-6 tw-leading-8 md:tw-leading-10">
        <div>I am a stick insect.</div>
        <div class="tw-flex">I know how to <div class="droppable question tw-mx-2 tw-border-b tw-border-amber-700 tw-w-28 tw-h-10 ui-droppable" data-answer="pretend"></div> .</div>  
      </div>
    </div>
  </div>
@endsection
