...
(function($) {
    ...
    $('.droppable').droppable({
        ...
        drop: function(event, ui) {
            ...
            $(ui.draggable[0]).removeClass('!bg-green-200'); 
            $(ui.draggable[0]).removeClass('!bg-red-200'); 
            ...
            if(result['allAnswered']){
                ...
                $(".draggable-item").addClass('!bg-green-200');
                ...
                if(result.wrong.length<=0){
                    ...
                    result.wrong.forEach(function(wrongItem){
                        $("[data-value="+wrongItem+"]").removeClass('!bg-green-200'); 
                        $("[data-value="+wrongItem+"]").addClass('!bg-red-200');
                        setTimeout(function() {
                            $('[now-answer='+wrongItem+']').attr('now-answer','');
                            $("[data-value="+wrongItem+"]").removeClass('!bg-red-200'); 
